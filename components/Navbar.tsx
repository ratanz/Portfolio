...
export function Navbar() {
  ...
  return (
    <>
      <div ref={navbarRef} className={`content h-12 px-20 py-6 flex justify-between items-center fixed font-pretendard  transition-all duration-300 backdrop-blur-md z-[60] w-[80%] ml-[10%] mt-4 rounded-xl bg-zinc-950/50 
      `}
